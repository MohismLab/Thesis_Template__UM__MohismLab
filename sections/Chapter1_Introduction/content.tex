...
Those pages should be single-sided when printing, \textit{i.e.}, an empty page should be strictly followed. Besides, and the page numbers should not be presented on those pages.
